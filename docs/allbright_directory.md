...
├── allbright_directory.md (6.2KB) - This file
├── pnpm-workspace.yaml (0.3KB) - Monorepo
├── rust-toolchain.toml (0.2KB) - Rust toolchain
├── TODO.md (1.8KB) - Debug tracking
├── allbright_subsystems.md (8.5KB) - Legacy subsystems spec
├── allbright-rust-restructure-plan.md (4.1KB) - Rust migration plan
...
├── pnpm-workspace.yaml (0.3KB) - Monorepo
├── TODO.md (1.8KB) - Debug tracking
├── allbright_subsystems.md (8.5KB) - 39 subsystems spec
...
```bash
cargo run --bin allbright    # BSS-26 Watchtower (39 subsystems)
pnpm --filter ui dev         # BSS-27 Dashboard
docker build -t allbright .  # BSS-37 Hermetic
```
