...
- **Windows Runtime Requirement**:
  - The app requires **Microsoft Edge WebView2**.
  - If the MSI fails to launch, install the WebView2 Runtime manually.
  - The installer is configured in `downloadBootstrapper` mode to resolve build-time timeouts.
