Here’s a refined and **deployment-ready “Live Simulation Mode” version** of your **allbright BUILDER AGENT**, with clearer automation logic, stricter constraints handling, and execution-safe structure:

---

# **allbright BUILDER AGENT — LIVE SIMULATION MODE (Pre-Deployment)**
...
**Purpose:** Verify system meets benchmark-30-kpis.md (7 categories, ai/kpi-specialists.md) before execution
