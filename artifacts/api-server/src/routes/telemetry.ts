...
router.get("/telemetry", async (req, res) => {
  ...
  res.json({
    ...
    chainMatrix: {
      activeChains: [1, 8453, 42161, 137, 10, 56, 43114, 59144, 534352, 81457, 324],
    ...
    opportunitiesDetected: executed.length > 0 ? Math.ceil(executed.length * 1.4) : 0, // scan attempts vs executions
